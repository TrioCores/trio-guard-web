...
const AuthTemplate = ({ onLogin }: AuthTemplateProps) => {
        ...
        <div className="max-w-lg w-full p-8 bg-white rounded-xl shadow-md">
          <div className="text-center mb-8">
            ...
            <p className="text-trioguard-dark/80">
              Log in with your Discord account to manage TrioGuard in your
              servers.
            </p>
          </div>
          ...
          <div className="mt-6 text-center text-sm text-trioguard-dark/60">
            ...
            <a
              href="/#invite"
              className="text-trioguard font-medium hover:underline"
            >
