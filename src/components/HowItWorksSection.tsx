      ...
      <div className="container-custom">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
          ...
          {steps.map((step, index) => (
            ...
            >
              <div className="bg-trioguard text-white text-xl font-bold w-12 h-12 flex items-center justify-center rounded-full mb-6">
                {step.number}
              </div>
        ...
        <div className="mt-16 text-center">
          <a href="#invite" className="btn-primary inline-flex items-center">
